...
type Props = Readonly<{
  initialValues: AddIncomeData
  onSubmit: (values: AddIncomeData) => void
  isPending: boolean
  onCancel: () => void
}>

const BaseIncomeForm = ({
  initialValues,
  onSubmit,
  isPending,
  onCancel,
    ...
    >
          ...
          return (
            <Field aria-disabled={isPending} data-invalid={isInvalid}>
              ...
              <Input
                ...
                placeholder="The High Table Inc."
                autoComplete="off"
              />
              {isInvalid && <FieldError errors={field.state.meta.errors} />}
            </Field>
              ...
              >
                ...
                >
                  ...
                  <SelectContent alignItemWithTrigger={false}>
                    <SelectGroup>
                      {addIncomeSchema.shape.category.options.map((option) => (
      ...
      >
        ...
        <Button disabled={isPending} type="submit">
          <LoadingSwap isLoading={isPending}>Save Income</LoadingSwap>
        </Button>
      </Field>
    </form>
  )
